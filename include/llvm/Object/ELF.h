...
error_code ELFObjectFile<ELFT>::getRelocationTypeName(
  ...
  case ELF::EM_HEXAGON:
    ...
    break;
  case ELF::EM_RH850:	// llvm-objdump -t -r
    switch (type) {
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_NONE);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_REL32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_24);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GPREL16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_LITERAL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GOT16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_PC24);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_CALL24);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GPREL32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_SHIFT5);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_SHIFT6);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_64);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GOT_DISP);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GOT_PAGE);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GOT_OFST);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GOT_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GOT_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_SUB);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_INSERT_A);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_INSERT_B);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_DELETE);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_HIGHER);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_HIGHEST);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_CALL_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_CALL_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_SCN_DISP);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_REL16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_ADD_IMMEDIATE);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_PJUMP);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_RELGOT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_JALR);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_DTPMOD32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_DTPREL32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_DTPMOD64);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_DTPREL64);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_GD);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_LDM);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_DTPREL_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_DTPREL_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_GOTTPREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_TPREL32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_TPREL64);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_TPREL_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_TLS_TPREL_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_GLOB_DAT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_COPY);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_JUMP_SLOT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_RH850_NUM);
    default:
      res = "Unknown";
    }
    break;
