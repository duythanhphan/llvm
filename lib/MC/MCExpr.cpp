...
StringRef MCSymbolRefExpr::getVariantKindName(VariantKind Kind) {
  ...
  case VK_Cpu0_DTPREL_HI: return "DTPREL_HI";
  case VK_Cpu0_DTPREL_LO: return "DTPREL_LO";
  case VK_Cpu0_GOTTPREL: return "GOTTPREL";
  case VK_Cpu0_TPREL_HI: return "TPREL_HI";
  case VK_Cpu0_TPREL_LO: return "TPREL_LO";
