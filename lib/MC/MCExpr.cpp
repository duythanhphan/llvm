...
StringRef MCSymbolRefExpr::getVariantKindName(VariantKind Kind) {
  ...
  case VK_Rh850_GPREL: return "GPREL";
  case VK_Rh850_GOT_CALL: return "GOT_CALL";
  case VK_Rh850_GOT16: return "GOT16";
  case VK_Rh850_GOT: return "GOT";
  case VK_Rh850_ABS_HI: return "ABS_HI";
  case VK_Rh850_ABS_LO: return "ABS_LO";
  case VK_Rh850_TLSGD: return "TLSGD";
  case VK_Rh850_TLSLDM: return "TLSLDM";
  case VK_Rh850_DTPREL_HI: return "DTPREL_HI";
  case VK_Rh850_DTPREL_LO: return "DTPREL_LO";
  case VK_Rh850_GOTTPREL: return "GOTTPREL";
  case VK_Rh850_TPREL_HI: return "TPREL_HI";
  case VK_Rh850_TPREL_LO: return "TPREL_LO";
  case VK_Rh850_GPOFF_HI: return "GPOFF_HI";
  case VK_Rh850_GPOFF_LO: return "GPOFF_LO";
  case VK_Rh850_GOT_DISP: return "GOT_DISP";
  case VK_Rh850_GOT_PAGE: return "GOT_PAGE";
  case VK_Rh850_GOT_OFST: return "GOT_OFST";
  }
